...
public class HomeController : Controller
{
    ...
    public async Task<IActionResult> Index(CancellationToken cancellationToken)
    {
        ...
        var viewModel = new HomeDashboardViewModel
        {
            ...
            {
                new("Préstamos", "Consulta historial, activa préstamos y revisa extensiones.", "🔁", "text-primary", controller: "Prestamo", action: "Index"),
                new("Libros", "Administra títulos, ejemplares y disponibilidad.", "📚", "text-success", page: "/Libros/Index"),
                new("Usuarios", "Gestiona perfiles y accesos de lectores.", "👤", "text-info", controller: "Usuario", action: "Index"),
                new("Penalizaciones", "Controla sanciones y desbloqueos.", "⚠️", "text-danger", controller: "Penalizacion", action: "Index"),
                new("Reportes", "Genera KPIs y métricas académicas.", "📈", "text-secondary", controller: "Reporte", action: "Index"),
                new("Notificaciones", "Envía alertas y recordatorios automáticos.", "🔔", "text-warning", controller: "Notificacion", action: "Index")
            },
